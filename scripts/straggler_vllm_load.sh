...
# Light straggler workload:
# - Small stream is IDENTICAL to baseline (RPS, lengths, num-prompts).
# - Introduce a very low rate of long requests.
# - Long outputs are much longer (1024 tokens) but num-prompts capped.
